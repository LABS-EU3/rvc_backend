...
exports.seed = function(knex) {
  return knex('recipes').insert([
    ...
    },
    {
      ...
      instructions: JSON.stringify([
        'Sift the flour and salt into a large bowl. Sprinkle over the oil, and add enough water to make a soft dough – add a little more flour or water if needed. Knead gently until smooth. Cover and leave to rest for about 30 minutes.',

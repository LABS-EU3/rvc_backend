...
const { validateProfileDetails } = require('../middlewares/validateProfileDetails');
...
router.post('/', validateToken, checkProfileExists, validateProfileDetails, createProfile);
router.put('/', validateToken, checkProfileExists, validateProfileDetails, editProfile);
